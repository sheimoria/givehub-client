...
export type Query = {
  ...
  eventsByCategories: PaginatedEvents;
  searchEvents: PaginatedEvents;
  event?: Maybe<Event>;
  getVolunteerRequestListForEvent: PaginatedEventVolunteers;
};
...
export type QueryEventsByCategoriesArgs = {
  cursor?: Maybe<Scalars['String']>;
  categories: Array<Scalars['Float']>;
  sortByUpcoming: Scalars['Boolean'];
  sortByLikes: Scalars['Boolean'];
...
export type QueryGetVolunteerRequestListForEventArgs = {
  cursor?: Maybe<Scalars['String']>;
  limit: Scalars['Int'];
  eventId: Scalars['Int'];
};
...
export type CharitySignUpMutation = (
  { __typename?: 'Mutation' }
  & { createCharity: (
    { __typename?: 'CharityResponse' }
...
export type CharityQuery = (
  ...
  & { charitySearchByID?: Maybe<(
    { __typename?: 'Charity' }
    & Pick<Charity, 'id' | 'name' | 'uen' | 'physicalAddress' | 'postalcode'>
    & { charityEvents: Array<(
      { __typename?: 'Event' }
      & Pick<Event, 'id'>
    )> }
...
export type EventQuery = (
  ...
  & { event?: Maybe<(
    { __typename?: 'Event' }
    & Pick<Event, 'id' | 'name' | 'createdAt' | 'description' | 'dateStart' | 'dateEnd' | 'venue' | 'likeNumber' | 'voteStatus'>
    & { charity: (
      { __typename?: 'Charity' }
      & Pick<Charity, 'id' | 'name'>
    ) }
...
export const CharitySignUpDocument = gql`
  ...
  createCharity(options: $options) {
    ...
    `;
export type CharitySignUpMutationFn = Apollo.MutationFunction<CharitySignUpMutation, CharitySignUpMutationVariables>;
 ...
 * });
 */
export function useCharitySignUpMutation(baseOptions?: Apollo.MutationHookOptions<CharitySignUpMutation, CharitySignUpMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CharitySignUpMutation, CharitySignUpMutationVariables>(CharitySignUpDocument, options);
      }
export type CharitySignUpMutationHookResult = ReturnType<typeof useCharitySignUpMutation>;
export type CharitySignUpMutationResult = Apollo.MutationResult<CharitySignUpMutation>;
export type CharitySignUpMutationOptions = Apollo.BaseMutationOptions<CharitySignUpMutation, CharitySignUpMutationVariables>;
...
export const CategoryEventsDocument = gql`
...
/**
 * __useCategoryEventsQuery__
 *
 * To run a query within a React component, call `useCategoryEventsQuery` and pass it any options that fit your needs.
 * When your component renders, `useCategoryEventsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 ...
 * });
 */
export function useCategoryEventsQuery(baseOptions: Apollo.QueryHookOptions<CategoryEventsQuery, CategoryEventsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<CategoryEventsQuery, CategoryEventsQueryVariables>(CategoryEventsDocument, options);
      }
export function useCategoryEventsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<CategoryEventsQuery, CategoryEventsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<CategoryEventsQuery, CategoryEventsQueryVariables>(CategoryEventsDocument, options);
        }
export type CategoryEventsQueryHookResult = ReturnType<typeof useCategoryEventsQuery>;
export type CategoryEventsLazyQueryHookResult = ReturnType<typeof useCategoryEventsLazyQuery>;
export type CategoryEventsQueryResult = Apollo.QueryResult<CategoryEventsQuery, CategoryEventsQueryVariables>;
