      ...
      <nav>
        <p className="secondary">
          ...
          <a
            ...
            href="https://www.github.com/sheimoria"
            target="_blank"
            rel="noreferrer"
          >
            Shem
          ...
          <a
            className="font-medium transition-colors hover:text-gray-500 dark:hover:text-gray-400"
            href="https://github.com/vigneshsankariyer1234567890"
            target="_blank"
            rel="noreferrer"
          >
            Vignesh
        ...
        <div className="flex gap-4">
          ...
          >
            ...
            <svg
              className="transition-colors text-rose-600 hover:text-rose-700 dark:hover:text-rose-500"
              aria-hidden="true"
              fill="currentColor"
              viewBox="0 0 20 20"
            >
