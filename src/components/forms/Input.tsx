    ...
    <div className="flex flex-col flex-1 gap-2 transition">
      ...
      <div className="relative">
        <input
          ...
          {...register(name)}
          className={`w-full px-4 py-2 text-sm text-gray-700 placeholder-gray-500 bg-gray-100 rounded-md focus:ring-1 focus:ring-rose-600 focus:outline-none dark:text-gray-200 dark:placeholder-gray-400 dark:bg-gray-700 ${className}`}
          onFocus={onFocus}
          onBlur={onBlur}
          autoComplete="off"
        />
