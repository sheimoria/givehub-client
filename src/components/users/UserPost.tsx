    ...
    <>
      <Transit as="article" className="flex-row items-center px-6 pb-6">
        ...
        <button
          ...
          className="flex flex-1 px-4 py-2 text-sm transition-colors bg-gray-100 rounded-md secondary dark:hover:bg-gray-600 hover:bg-gray-200 dark:bg-gray-700 hover:text-gray-500 dark:hover:text-gray-400"
        >
          New Post
        </button>
      </Transit>
